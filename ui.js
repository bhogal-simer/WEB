...
function toggleLoading(isLoading) {
  if (isLoading) {
    document.querySelector("#flatIcon").removeAttribute("class");
    document
      .querySelector("#flatIcon")
      .setAttribute("class", "fas fa-hourglass-half");
    document.querySelector("#SearchButtonText").innerHTML = "Loading...";
  } else {
    document.querySelector("#flatIcon").setAttribute("class", "fas fa-search");
    document.querySelector("#SearchButtonText").innerHTML = "Search";
  }
}
